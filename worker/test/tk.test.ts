...
//
// Grammar note (flagged in DEVLOG): tk-core-plan.md §2.1's illustrated
// examples show a literal "]" closing the instruction (e.g.
// "[TK <instruction>][/TK]"), but the prose two lines later is explicit that
// parsing is a 3-token linear scan ("[TK" ... optional "[=]" ... "[/TK]")
// with "no bracket balancing" so that "![[id]]" refs never need escaping.

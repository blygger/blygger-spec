...
| [`docs/spec-publishing-plan.md`](docs/spec-publishing-plan.md) | PLAN, not executed (session 8, Fable) — Sonnet/Opus-safe: keep `blygger.org/spec/` current via sync script + dated snapshots + git tags; records the spec-as-blyg rejection (decision #15) |

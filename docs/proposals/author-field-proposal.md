...
- **One feed = one human author** — this is not load-bearing. A community studio, a
  ...
  whose items carry different bylines, without blyg becoming a social protocol.
...
5. **Never addressable.** No protocol construct references an author. Transclusion
   ...
   blyg is an addressable *content* system, not a social system. There will never be a
